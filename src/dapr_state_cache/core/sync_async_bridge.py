...
def get_thread_pool() -> concurrent.futures.ThreadPoolExecutor:
    ...
    following Python's default pattern: min(32, (os.cpu_count() or 1) + 4).
    ...
    if _thread_pool is None:
        ...
        _thread_pool = concurrent.futures.ThreadPoolExecutor(
            ...
            thread_name_prefix="dapr-cache-sync"
        )
...
class SyncAsyncBridge:
    ...
    def __init__(self, thread_pool: Optional[concurrent.futures.ThreadPoolExecutor] = None) -> None:
...
_default_bridge: Optional[SyncAsyncBridge] = None
