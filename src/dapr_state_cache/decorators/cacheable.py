...
def cacheable(
...
) -> Callable[[F], Union[CacheableWrapper, F]]:
    ...
    """
    def decorator(func: F) -> Union[CacheableWrapper, F]:
        ...
        try:
            ...
            resolved_crypto_name = CacheConfig.resolve_crypto_component_name(crypto_component_name) if use_dapr_crypto else None
