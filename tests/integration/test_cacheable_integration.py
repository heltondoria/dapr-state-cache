...
class TestEnvironmentConfiguration:
    ...
    @patch.dict(os.environ, {
        'DAPR_CACHE_DEFAULT_STORE_NAME': 'env_store',
        'DAPR_CACHE_DEFAULT_CRYPTO_NAME': 'env_crypto'
    })
    @patch('dapr.clients.DaprClient')
