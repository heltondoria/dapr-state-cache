...
class PickleSerializer:
    ...
    def serialize(self, data: Any) -> bytes:
        ...
        try:
            ...
            raise TypeError(f"Pickle serialization failed: {e}") from e
    ...
    def deserialize(self, data: bytes) -> Any:
        ...
        try:
            ...
            raise ValueError(f"Pickle deserialization failed: {e}") from e
        except Exception as e:
            # Catch any other exceptions that might occur during unpickling
            raise ValueError(f"Unexpected error during pickle deserialization: {e}") from e
